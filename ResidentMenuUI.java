// [Module: Resident & Vehicle Management — Iman, Member 1. NOTE: this class is not referenced by Main.java and appears to be an earlier draft; patched by Firdaus, Member 2, only to keep the project compiling.]
...
public class ResidentMenuUI {
    ...
    public ResidentMenuUI(ResidentManager manager, BookingManager bookingManager, StationManager stationManager) {
    ...
    public ResidentMenuUI(ResidentManager manager, BookingManager bookingManager) {
        this(manager, bookingManager, null);
    }
